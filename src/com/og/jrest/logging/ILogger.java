...
public interface ILogger extends AutoCloseable {
	 ...
	 * 
	 * @param output
	 *            stream to which all logs will be written.
	 */
	 ...
	 * 
	 * @param file
	 *            file to which all logs will be written
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param output
	 *            stream to which exception logs will be written.
	 */
	 ...
	 *
	 * @param file
	 *            file to which exception logs will be written
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param output
	 *            stream to which error logs will be written.
	 */
	 ...
	 *
	 * @param file
	 *            file to which error logs will be written
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param output
	 *            stream to which debug logs will be written.
	 */
	 ...
	 *
	 * @param file
	 *            file to which debug logs will be written
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param output
	 *            stream to which info logs will be written.
	 */
	 ...
	 *
	 * @param file
	 *            file to which info logs will be written
	 * @throws IOException
	 */
	 ...
	 *            file to which exception logs will be written
	 * @param append
	 *            if true, existing file contents will be appended to
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param file
	 *            file to which info logs will be writting
	 * @param append
	 *            if true, existing file contents will be appended to
	 * @throws IOException
	 */
